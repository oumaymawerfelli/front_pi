...
import { Product } from 'src/app/core/models/Product'; // Assurez-vous que le chemin est correct
import { ProductService } from 'src/app/core/services/product.service'; // Assurez-vous que le chemin est correct
import { LignePanierService } from 'src/app/core/services/LingePanier.service '; // Assurez-vous que le chemin est correct
import { LignePanier } from 'src/app/core/models/LignePanier'; // Assurez-vous que le chemin est correct
import { Router } from '@angular/router';
import { HttpClient, HttpHeaders } from '@angular/common/http';
import { PanierService } from 'src/app/core/services/Panier.service'; // Assurez-vous que le chemin est correct
